...
public class FindAPro {
    ...
    CommandLineRunner commandLineRunner(OfferRepository offerRepository, RequestRepository requestRepository, CustomerRepository customerRepository, HandymanRepository handymanRepository) {
        return args -> {
            offerRepository.save(new Offer(new ArrayList<>(Arrays.asList(34, 33, 32)), 33.00f, "SE1", true, "wall painting", 6));
            offerRepository.save(new Offer(new ArrayList<>(Arrays.asList(34, 13, 22)), 23.00f, "SE1", true, "wall painting", 7));
            ...
            offerRepository.save(new Offer(new ArrayList<>(Arrays.asList(33, 32, 13)), 30.00f, "SW12", true, "drilling", 8));
        };
    }
}
